...
public class ProgressAppGlideModule extends AppGlideModule {
                ...
                .addNetworkInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        ...
                        return response.newBuilder()
                                .body(new OkHttpProgressResponseBody(request.url().toString(), response.body(), listener))
                                .build();
                    }
                })
                .build();
    ...
    private interface ResponseProgressListener {
        void update(String url, long bytesRead, long contentLength);
    }
    ...
    private static class DispatchingProgressListener implements ProgressAppGlideModule.ResponseProgressListener {
        ...
        @Override
        public void update(String url, final long bytesRead, final long contentLength) {
